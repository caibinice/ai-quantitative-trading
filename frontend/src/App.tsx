...
export default function App() {
  return <Layout><Suspense fallback={<Loading label="加载研究模块…" />}><Routes><Route path="/" element={<Dashboard />} /><Route path="/market" element={<Market />} /><Route path="/rankings" element={<Rankings />} /><Route path="/sentiment" element={<Sentiment />} /><Route path="/strategy" element={<Strategy />} /><Route path="/walk-forward" element={<WalkForward />} /><Route path="/tasks" element={<Tasks />} /><Route path="/data-quality" element={<DataQuality />} /></Routes></Suspense></Layout>
}
