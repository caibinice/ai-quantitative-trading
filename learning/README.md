...
2. 阅读项目例子、常见误区和动手练习，并直接下载对应源码。
3. 运行本章 Demo，修改一个参数并解释输出变化。
4. 完成 Checklist。
5. 完成 3 道小测验，至少答对 2 道。
6. 把不理解的点记录到自己的研究日志。

十章共包含 30 个详情页，每页都有项目内示例、可视流程、误区、练习和延伸阅读。章节页与详情页列出的源码、测试和 Demo 都可以点击下载；下载接口只开放教学相关目录，不会提供凭证、环境文件或 Git 元数据。
